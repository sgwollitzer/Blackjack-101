...
const History = () => {
  ...
  <li>Edward Thorp detailed a "ten-count system" in the book <u>Beat the Dealer</u> that became one of the most famous card counting strategies to ever exist.</li>
  </ul>
  <h2 className="h2T">
    Now
  </h2>
