...
const History = () => {
  ...
  <li>Around the time of WWI, "21" came to the US with a twist: a reward was given if a player had an ace of spades and a blackjack. This reward and its name cuaght on and the game of "21" became the game of "Backjack" in the US. Finally, in 1931, Nevada created house-banked blackjack.</li>
  </ul>
  <h2>Blackjack's Most Famous Players</h2>
  <ul>
